...
enum token_type { NONE, COMMA , PASS_CMD, NICK_CMD, USER_CMD, PRIVMSG_CMD, JOIN_CMD, KICK_CMD, PART_CMD, TOPIC_CMD, INVITE_CMD, MODE_CMD, LOGTIME_CMD, WHOIS_CMD, LOCATION_CMD, CHANNEL, KEY, NICK, MSG, TOPIC_MSG, COMMENT, MODE_STR, REASON, MODE_ARG, LOG_BEG, LOG_END, PASS, USER, TARGET};
struct token
{
    token_type type;
    std::string data;
